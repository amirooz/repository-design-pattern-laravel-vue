    ...
    <div class="wrapper" id="app">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/assets/img/profile.png" alt="User Avatar" class="img-size-50 mr-3 img-circle" />
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/assets/img/profile.png" alt="User Avatar" class="img-size-50 img-circle mr-3" />
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        John Pierce
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/home" class="brand-link">
                ...
                style="opacity: .8" />
                <span class="brand-text font-weight-light">Political Intelligence</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; <?php echo date('Y'); ?> BNP.</strong> All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
