            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Mahanagar List</h3>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                        ...
                                        <tbody>
                                            <tr v-for="item in items.data" :key="item.id">
                                                ...
                                                <td v-if="item.image"> <img class="img-bordered-ssm" :src="getImage(item.image)" width="100%" height="25" alt="Mahanagar image" /> </td>
                                                <td v-else> <img class="img-bordered-ssm" src="/assets/img/img404.png" width="100%" height="25" alt="Mahanagar image" /> </td>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 v-show="editMode" class="modal-title" id="addNewModelLabel">Update Mahanagar</h5>
                        <h5 v-show="!editMode" class="modal-title" id="addNewModelLabel">Add Mahanagar</h5>
                    ...
                    <form @submit.prevent="editMode ? update() : create()" @keydown="form.onKeydown($event)" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                placeholder="Enter mahanagar name..."
...
<script>
    export default {
        ...
        methods: {            
            ...
            loadData(){
                axios.get('api/mahanagar').then(({ data }) => (this.items = data ));
            },

            pagination(page = 1) {
                axios.get('api/mahanagar?page=' + page)
                .then(response => {
            ...
            getImage(img){
                return "assets/img/mahanagar/" + img;
            },
            ...
            update() {
                this.$Progress.start();
                this.form.put('api/mahanagar/' + this.form.id)
                .then(() => {
                    $('#addNewModel').modal('hide');
                    Fire.$emit('reloadData');
                    Toast.fire({
