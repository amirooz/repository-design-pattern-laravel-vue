                            ...
                            <div class="tab-content" id="myTabContent">
                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped dataTable bigData" role="grid" aria-describedby="example1_info">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr v-for="(item, x) in committee" :key="x">
                                                                ...
                                                                <td v-if="item.post_committee === 'Union Executive'">{{item.designation}}</td>
                                                                <td v-else>Member</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                ...
                                <div class="tab-pane fade" id="word" role="tabpanel" aria-labelledby="word-tab">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10">
                                            <div v-for="(committees, index) in wordDetails" :key="index" class="tab-content" id="v-pills-tabContent">
                                                <div v-for="(committee, i) in committees" :key="i" :class="'tab-pane fade '+ getTabConClass(i)" :id="'v-pills-'+i" role="tabpanel" aria-labelledby="v-pills-word-1">
